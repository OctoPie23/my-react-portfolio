...
description: "This is a program that uses Python BeautifulSoup to fetch data from https://merolagani.com and on the basis of the percentage change, it alerts the user."
