...
description: "This repository contains my files from the HTML project from the FreeCodeCamp tutorial. I completed this project to brush up on my HTML skills."
