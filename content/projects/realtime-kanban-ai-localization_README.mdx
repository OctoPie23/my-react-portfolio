---
title: 'realtime-kanban-ai-localization'
description:
  'Real-time Kanban board with websockets 🔗, Tolgee for language detection and
  translation 🐁, PostgreSQL as DB and Vercel AI SDK for task description 🤖 '
clone_url: 'https://github.com/shricodev/realtime-kanban-ai-localization.git'
language: 'TypeScript'
homepage: ''
topics:
  - 'showcase'
created_at: '2024-11-08T08:48:15Z'
updated_at: '2024-11-08T08:51:00Z'
---
...
Welcome to my **Kanban Board** implementation, an advanced task management app
that combines real-time collaboration, multi-language support, and AI-generated
task descriptions! Built with **Tolgee** for localization, **Vercel AI SDK** for
intelligent task descriptions, and **Socket.IO** for seamless real-time updates.
...
- **AI-Powered Task Descriptions**: Generate meaningful task descriptions on the
  fly with OpenAI & Vercel AI SDK.
- **Real-time Collaboration**: Socket.IO enables live updates for connected
  clients.
- **Backend with PostgreSQL & Prisma**: Reliable data storage and easy-to-manage
  schema with Prisma ORM.
- **Drag-and-Drop with React-Beautiful-DND**: Smooth and intuitive task
...
> 👀 If you wish to test the project right away with PostgreSQL inside your
> local machine with Docker, I have created a custom script that will initialize
> the database.

- **Optional: Start the Docker service**:

If the Docker service is not running, you can start it with the following
command:
...
This script should start a Docker container with PostgreSQL image. Make sure you
have populated the `.env` file with the following `DATABASE_URL`
...
If you've initialized the project with default values, your Kanban board should
...
if you’d like to improve the project. Check the
...
Thanks to [Tolgee](https://tolgee.io/), [OpenAI](https://openai.com/), and
[Vercel](https://vercel.com/) for providing incredible APIs to build with.
Special thanks to all the open-source projects and libraries that made this
project possible.
