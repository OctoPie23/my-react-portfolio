...
description: "Real-time Kanban board with websockets 🔗, Tolgee for language detection and translation 🐁, PostgreSQL as DB and Vercel AI SDK for task description 🤖 "
